...
2.4. Piedaloties Konkursā, Dalībnieks apstiprina, ka iepazinies ar šo nolikumu un piekrīt tā noteikumiem.
...
## 4. Prasības iesniegtajiem darbiem

4.1. Darba koncepcijai (idejai, vārdam, stāstam) jābūt Dalībnieka paša radītai; AI rīku izmantošana vizuālā tēla veidošanā ir sagaidāma un atbalstīta, taču pati ideja un stāsts ir Dalībnieka radošais devums.

4.2. Darbs nedrīkst saturēt:
   - aicinājumus uz vardarbību, naida runu vai diskrimināciju;
   - seksualizētu vai nepiemērotu saturu;
   - trešo personu attēlus, vārdus vai zīmolus bez atļaujas;
   - reklāmu vai citu ar Konkursa tēmu nesaistītu komerciālu saturu.
